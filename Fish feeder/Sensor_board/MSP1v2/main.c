...
unsigned int step[8] = {0x20, 0x30, 0x10, 0x18, 0x08, 0x0C, 0x04, 0x24}; //step sequence for pins 4-7
int i = 0;
int power = 0;
int feed = 0;

//Cleaning reminder
int clean = 1; // filter is clean
...
void enable_motor(int feed)
{
	...
	{    //4000 cycles ~ full turn, 2000 cycles ~ half turn
			...
			__delay_cycles(1000);//99Hz for 28BYJ-48
	}
}
